				...
				if (usbDevice.VendorID == 0x04b4 && usbDevice.ProductID == 0x1004)
				{
					if (fx2Devices.Count(p => p.USBDevice == usbDevice) == 0)
					{
						...
						else
						{
							...
							switch (deviceType)
							{
								case Fx2Device.EDeviceType.DAC: fx2Devices.Add(new DACDevice(usbDevice, null, deviceType)); break;
								case Fx2Device.EDeviceType.ADC: fx2Devices.Add(new ADCDevice(usbDevice, null, deviceType)); break;
								case Fx2Device.EDeviceType.DAC_C: fx2Devices.Add(new DACDevice(usbDevice, null, deviceType)); break;
